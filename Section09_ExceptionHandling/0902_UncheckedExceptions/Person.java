...
public abstract class Person implements Comparable {
    ...
    public Person(String firstName, String lastName, int age)
    {
        ...
        {
            //throw a new illegal argument exception to prevent
            //bad user input to our custom class.
    ...
    {
        //we don't want the user to give an age < 1 or greater than 140
    ...
    public boolean equals(Object obj)
    {
        ...
        return (Common.nullSafeEquals(this.getLastName(), p.getLastName())
                && Common.nullSafeEquals(this.getFirstName(), p.getFirstName())
