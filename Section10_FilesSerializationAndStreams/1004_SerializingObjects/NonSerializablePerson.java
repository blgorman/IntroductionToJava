 ...
 * @author Brian
 */
public abstract class NonSerializablePerson implements Comparable {
     ...
     */
    public NonSerializablePerson(String firstName, String lastName, int age)
    {
